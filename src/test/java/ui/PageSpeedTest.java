...
public class PageSpeedTest extends TestBase {
    ...
    public void testPagespeed() throws IOException, GitLabApiException {
        ...
        if (percentDesktop < 50) {
            ...
            app.uploadIssueWithScreenshotToGitlab("Google PageSpeed Desktop percentage value need to be more than 50", "PageSpeedTestDesktop");
        } else {
            logger.info("Google PageSpeed Desktop is up to date. Right now it's value is - " + percentDesktop);
        }
    }
